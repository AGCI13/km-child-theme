...
<p><?php echo apply_filters( 'woocommerce_my_account_my_address_description', esc_html__( 'The following addresses will be used on the checkout page by default.', 'woocommerce' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
</p>
...
<div class="bloc-adresses">
	...
	<div class="encart-adresse">
		<p><?php echo $address ? wp_kses_post( $address ) : esc_html_e( 'You have not set up this type of address yet.', 'woocommerce' ); ?>
		</p>
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', 'billing' ) ); ?>"
			class="edit modifier-adresses"><?php echo esc_html__( 'Modifier l\'adresse', 'woocommerce' ); ?></a>
	</div>
...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post"
	...
	<fieldset>
		<legend><?php esc_html_e( 'Besoin de changer votre mot de passe ? Renseignez le :', 'woocommerce' ); ?></legend>
