...
<img id="km-order-steps" src="<?php echo get_stylesheet_directory_uri() . '/assets/img/wc-order-steps-confirmed.jpg'; ?>" alt="order step" />
...
<h2><?php echo __('Vos informations de livraison', 'woocommerce'); ?></h2>
