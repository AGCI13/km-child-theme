	...
	<tr>
		...
		<td class="order-data">
			<table>
				...
				<?php if ( $shipping_post_meta = get_post_meta( $order->get_order_number(), '_shipping_dates', true ) ) : ?>
				<tr class="order-shpping-date">
					<th><?php esc_html_e( 'Date de livraison prévue :', 'kingmateriaux' ); ?></th>
					<td>		
					<?php echo esc_html( $shipping_post_meta ); ?>
					</td>
				</tr>
				<?php endif; ?>
